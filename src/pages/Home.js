        ...
        <>
            {
                (!props.admin) ? (<> <div className="homeContainer">
                    ...
                    <div className='centerc'><img src={Visa} width="90px" alt='img'></img>
                        <img style={{ margin: "0 10px" }} src={Mastercard} width="90px" alt='img'></img>
                        <img style={{ margin: "0 10px" }} src={BTC} width="90px" alt='img'></img>
                        <img style={{ margin: "0 10px" }} src={Paypal} width="90px" alt='img'></img>
                        <img src={Western} width="90px" alt='img'></img></div>
                </div></>) :
